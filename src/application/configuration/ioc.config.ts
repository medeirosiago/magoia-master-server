 ...
 * Adapters
 */
import { NotionAdapter, OpenAiAdapter, HomeAssitantAdapter } from '@application/configuration/ioc';
...
container.bind<HomeAssitantGateway>('HomeAssitantGateway').to(HomeAssitantAdapter);
