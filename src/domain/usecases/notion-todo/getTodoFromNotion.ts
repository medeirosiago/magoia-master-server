...
import {
  ...
  NotionPage,
  SimplifiedTask,
} from "@domain/entities/Notion"; // Importe os tipos definidos previamente

@injectable()
export class GetTodoFromNotionUseCase {
  constructor(@inject("Notion") private notionGateway: Notion) {}
...
export function mapNotionToSimplifiedTasks(
